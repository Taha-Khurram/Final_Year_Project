...
async function loadBestTimeSuggestions() {
  ...
  try {
    ...
    if (data.success && data.suggestions && data.suggestions.length > 0) {
      ...
      renderSuggestionChips(list, FALLBACK_SUGGESTIONS, 'rescheduleDateTime', false, data.message || null);
    }
  } catch (err) {
    renderSuggestionChips(list, FALLBACK_SUGGESTIONS, 'rescheduleDateTime', false, null);
  }
}
